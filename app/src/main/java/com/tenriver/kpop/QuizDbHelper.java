...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private static final int DATABASE_VERSION = 5; // 데이터베이스 버전 항상 다르게 하기 ( 2021.10.29기준 5)
    ...
    private void fillQuestionsTable() {
        ...
        Question q1 = new Question("4TWR90KJl84", "넥스트레벨","nextlevel","Next Level - Aespa",2021);	addQuestion(q1);
        Question q2 = new Question("WMweEpGlu_U", "버터","butter","Butter - BTS",2021);	addQuestion(q2);
        Question q3 = new Question("Kevp2lFKSOg", "스트로베리문","strawberrymoon","strawberry moon - 아이유",2021);	addQuestion(q3);
        Question q4 = new Question("SdHQkkRc-hc", "말해뭐해","talklove","Talk Love(말해! 뭐해?) -  K.will(케이윌)",2016);	addQuestion(q4);
        Question q5 = new Question("cIGgSI1uhKI", "봄이좋냐","whatthespring","봄이 좋냐?? (What The Spring??) - 10cm",2016);	addQuestion(q5);
        Question q6 = new Question("_3tIkwvUjJg", "이프유","ifyou","If You - Ailee(에일리)",2016);	addQuestion(q6);
        Question q7 = new Question("ST8O-AeY3Uo", "리바이","rebye","RE-BYE - AKMU",2016);	addQuestion(q7);
        Question q8 = new Question("kCSFdRf0210", "내가설렐수있게","onlyone","Only one(내가 설렐 수 있게) - Apink(에이핑크)",2016);	addQuestion(q8);
        Question q9 = new Question("AMWOLv4Y_0Y", "데이데이","dayday","Day Day (Feat. 박재범) - BewhY",2016);	addQuestion(q9);
        Question q10 = new Question("SX3pn5_arII", "포레버","forever","Forever (Prod. by GRAY) - BewhY",2016);	addQuestion(q10);
        Question q11 = new Question("iIPH8LFYFRk", "에라모르겠다","fxxxit","에라 모르겠다(FXXK IT) - BIGBANG",2016);	addQuestion(q11);
        Question q12 = new Question("dISNgvVpWlo", "휘파람","whistle","휘파람 (WHISTLE) - BLACKPINK",2016);	addQuestion(q12);
        Question q13 = new Question("bwmSjveL3Lc", "붐바야","boombayah","붐바야 (BOOMBAYAH) - BLACKPINK",2016);	addQuestion(q13);
        Question q14 = new Question("9pdj4iJD08s", "불장난","playingwithfire","불장난 (Playing With Fire) - BLACKPINK",2016);	addQuestion(q14);
        Question q15 = new Question("9U8uA702xrE", "우주를줄게","galaxy","우주를 줄게 - BOL4(볼빨간사춘기)",2016);	addQuestion(q15);
        Question q16 = new Question("y5MAgMVwfFs", "좋다고말해","tellmeyoulikeme","좋다고 말해 - BOL4(볼빨간사춘기)",2016);	addQuestion(q16);
        Question q17 = new Question("hmE9f-TEutc", "피땀눈물","bloodsweatandtears","피 땀 눈물 (Blood Sweat & Tears) - BTS (방탄소년단)",2016);	addQuestion(q17);
        Question q18 = new Question("4ujQOR2DMFM", "불타오르네","fire","불타오르네 (FIRE) - BTS (방탄소년단)",2016);	addQuestion(q18);
        Question q19 = new Question("fTc5tuEn6_U", "에브리타임","everytime","Everytime - CHEN(첸)XPunch(펀치)",2016);	addQuestion(q19);
        Question q20 = new Question("FNnYIIdTBhQ", "어떻게지내","fall","fall(어떻게 지내) - Crush(크러쉬)",2016);	addQuestion(q20);
        Question q21 = new Question("TcytstV1_XE", "잊어버리지마","dontforget","Don’t Forget(잊어버리지마) - Crush(크러쉬)",2016);	addQuestion(q21);
        Question q22 = new Question("XyzaMpAVm3s", "이사랑","thislove","This Love(이 사랑) - DAVICHI(다비치)",2016);	addQuestion(q22);
        Question q23 = new Question("eelfrHtmk68", "디","d","D (Half Moon) - Dean",2016);	addQuestion(q23);
        Question q24 = new Question("RnDSODY7bVE", "엘라이","lie","L.I.E 엘라이 - EXID(이엑스아이디)",2016);	addQuestion(q24);
        Question q25 = new Question("KSH-FVVtTf0", "몬스터","monster","Monster - EXO (엑소)",2016);	addQuestion(q25);
        Question q26 = new Question("0VKcLPdY9lI", "시간을달려서","rough","시간을 달려서 (Rough) - GFRIEND(여자친구)",2016);	addQuestion(q26);
        Question q27 = new Question("ToASX6axGuw", "유아마이에브리띵","youaremyeverything","You Are My Everything - Gummy(거미)",2016);	addQuestion(q27);
        Question q28 = new Question("WYy2fROj7uU", "그대라는사치","amazingyou","Amazing You(그대라는 사치) - Han Dong Geun(한동근)",2016);	addQuestion(q28);
        Question q29 = new Question("5iSlfF8TQ9k", "한숨","breathe","한숨 (BREATHE) - LEE HI",2016);	addQuestion(q29);
        Question q30 = new Question("va5rf20Un24", "어디에도","nomatterwhere","No matter where(어디에도) - M.C THE MAX(엠씨더맥스)",2016);	addQuestion(q30);
        Question q31 = new Question("QslJYDX3o8s", "러시안룰렛","russianroulette","러시안 룰렛 (Russian Roulette) - Red Velvet (레드벨벳)",2016);	addQuestion(q31);
        Question q32 = new Question("m7Zt_p9S-yg", "세단어","threewords","세 단어 (THREE WORDS) - SECHSKIES (젝스키스)",2016);	addQuestion(q32);
        Question q33 = new Question("J-wFp43XOrA", "아주나이스","verynice","VERY NICE(아주 NICE) - SEVENTEEN (세븐틴)",2016);	addQuestion(q33);
        Question q34 = new Question("Jkf8TrvtjTk", "사랑하자","bymyside","By My Side(사랑하자) - SG WANNABE(SG워너비)",2016);	addQuestion(q34);
        Question q35 = new Question("eHir_vB1RUI", "레인","rain","Rain - TAEYEON (태연)",2016);	addQuestion(q35);
        Question q36 = new Question("ePpPVE-GGJw", "티티","tt","TT (티티) - TWICE(트와이스)",2016);	addQuestion(q36);
        Question q37 = new Question("c7rCyll5AeY", "치얼업","cheerup","CHEER UP - TWICE(트와이스)",2016);	addQuestion(q37);
        Question q38 = new Question("gluvBLJYBjs", "셧업","shutup","Shut Up - Unnies(언니쓰)",2016);	addQuestion(q38);
        Question q39 = new Question("OV9NJGTLm-4", "센치해","sentimental","센치해(SENTIMENTAL) - WINNER",2016);	addQuestion(q39);
        Question q40 = new Question("PYGODWJgR-c", "와이소론리","whysolonely","Why So Lonely - Wonder Girls(원더걸스)",2016);	addQuestion(q40);
        Question q41 = new Question("bstWoRsocaw", "내옆에그대인걸","besideme","내 옆에 그대인 걸 (Beside me) - 다비치 (DAVICHI)",2016);	addQuestion(q41);
        Question q42 = new Question("QbhmTM1cRro", "넌이즈뭔들","yourethebest","넌 is 뭔들 (You're the best) - 마마무 (MAMAMOO)",2016);	addQuestion(q42);
        Question q43 = new Question("y2OFPvYxZuY", "데칼코마니","decalcomanie","Décalcomanie (데칼코마니) - 마마무 (MAMAMOO)",2016);	addQuestion(q43);
        Question q44 = new Question("BbQG-S4mU0U", "쏘쏘","soso","쏘쏘 - 백아연",2016);	addQuestion(q44);
        Question q45 = new Question("QL5KqjOZo6M", "같은곳에서","inthesameplace","같은 곳에서 (In the Same Place) - 소녀온탑 (Girls On Top)",2016);	addQuestion(q45);
        Question q46 = new Question("WfYgbFBFe1E", "드림","dream","Dream - 수지(Suzy), 백현(BAEKHYUN)",2016);	addQuestion(q46);
        Question q47 = new Question("LJVUjmNMF8c", "아이라이크댓","ilikethat","I Like That - 씨스타(SISTAR)",2016);	addQuestion(q47);
        Question q48 = new Question("GdxvD7r58ng", "너무너무너무","veryveryvery","너무너무너무 (Very Very Very) - 아이오아이 (I.O.I)",2016);	addQuestion(q48);
        Question q49 = new Question("MfYPKZl7W1w", "널사랑하지않아","idontloveyou","널 사랑하지 않아 (I Don't Love You) - 어반자카파(Urban Zakapa)",2016);	addQuestion(q49);
        ...
        Question q311 = new Question("oKUEbsJDvuo", "썸머헤이트","summerhate","Summer Hate (Feat. Rain(비)) - 지코 (ZICO)",2020);	addQuestion(q311);
        ...
        Question q352 = new Question("srWfDwiRVgQ", "와이돈위","whydontwe","WHY DON’T WE - RAIN (비)",2021);	addQuestion(q352);
        ...
        Question q386 = new Question("8A2t_tAjMz8", "낙낙","knockknock","KNOCK KNOCK - TWICE",2017); addQuestion(q386);
        Question q387 = new Question("kOHB85vDuow", "팬시","fancy","FANCY - TWICE",2019); addQuestion(q387);
